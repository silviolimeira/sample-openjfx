...
public class AES256 {
    ...
    public static void main(String[] args) {
        //String originalString = "howtodoinjava.com"; args[0]

        String encryptedString = AES256.encrypt(args[0], args[1], args[2]);
        String decryptedString = AES256.decrypt(encryptedString, args[1], args[2]);
